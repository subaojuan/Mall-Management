...
<form enctype="multipart/form-data"  action="/index.php/Admin/Categorys/cat_update/id/1.html" method="post">
  <ul class="list-group cate_add" id="cate_add" >
 	
    <li class="list-group-item" >
    	<label for="exampleInputName2">分类名称:</label>
    	<input type="text" name="c_name" class="form-control cate_input" id="exampleInputName2" value="<?php echo ($data["c_name"]); ?>" >
