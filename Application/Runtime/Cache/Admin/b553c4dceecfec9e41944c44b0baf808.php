...
<form enctype="multipart/form-data"  action="/index.php/Admin/Tips/tips_update/id/14.html" method="post">
  <ul class="list-group" id="cate_add" >
	   ...
	   <li class="list-group-item" >
	    	...
	    	<textarea id="myEditor" name="content" value=<?php echo ($data["content"]); ?> ></textarea>
	    </li>
    
    
     <li class="list-group-item"> 
    	<input type="hidden" name='id' value=<?php echo ($data["id"]); ?>  ></input>
  <button type="submit" class="btn btn-info">修改公告</button>	
