...
<li><a  style="text-decoration: none;" ><?php echo ($nav1); ?>     </a></li>
  ...
  <!-- 列表信息 -->  
  <div class="panel-heading">编辑学校名称</div>
  <div class="panel-body">
<form enctype="multipart/form-data"  action="/index.php/Admin/Areas/area_update/id/2.html" method="post">
  <ul class="list-group cate_add" id="cate_add" >
 	
    <li class="list-group-item" >
    	<label for="exampleInputName2">分类名称:</label>
    	<input type="text" name="a_name" class="form-control cate_input" id="exampleInputName2" value="<?php echo ($data["a_name"]); ?>" >
    	<input type="hidden" name="a_id" value="<?php echo ($data["a_id"]); ?>">
    </li>
    
     <li class="list-group-item"> 
    	
  <button type="submit" class="btn btn-info">修改学校名称</button>	
    </li>
