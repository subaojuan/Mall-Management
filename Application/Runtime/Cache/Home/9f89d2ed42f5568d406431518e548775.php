...
<div class="container" style="margin-left: -18px;">
	...
	<div class="panel panel-warning" >
	  ...
	  <form enctype="multipart/form-data"  action="/index.php/Home/Users/hg_update.html?h_id=9" method="post">
	  <ul class="list-group "  >	
 
	    <li class="list-group-item" >
	   <label for="exampleInputName2">求购名称:</label>
	    <input type="text"  name="h_name" class="form-control cate_input" id="" placeholder="请输入商品名称" value=<?php echo ($hg_data[0]["h_name"]); ?>  >
	    	
	    </li>

	    <li class="list-group-item" >
	    	<label for="exampleInputName2">求购数量:</label>
	    	<input type="text" name="h_num" class="form-control cate_input"  placeholder="请输入商品数量"  value=<?php echo ($hg_data[0]["h_num"]); ?>  >
	    ...
	    <li class="list-group-item" >
	    	...
	    	<input type="text"   name="h_price" class="form-control cate_input"  placeholder="请输入商品价格" value=<?php echo ($hg_data[0]["h_price"]); ?> >
	    ...
	    <li class="list-group-item" >
	    	...
	    	<textarea id="myEditor" name="h_desc"> 
	    		 <?php echo ($hg_data[0]["h_desc"]); ?> 
            </textarea>
	    </li> 
 
	     <li class="list-group-item" style="text-align: center;"> 
	    <input type="hidden" name="h_id" value=<?php echo ($hg_data[0]["h_id"]); ?> ></input> 		
	  <button type="submit" class="btn btn-warning" id="sale">更新信息</button>		
	     </li>
	</ul>	
	</form>
