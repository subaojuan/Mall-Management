...
<?php if(is_array($g_data)): foreach($g_data as $key=>$val): ?><div class="goods_list">  
<ul class="list-group" >
  <li class="list-group-item goods_li">
    <a  class="thumbnail" href=<?php echo U('Goods/goods_detail?g_id='.$val['g_id']);?> >
      <img src=/Public<?php echo ($val["g_logo"]); ?> >
    </a>
  </li>
  ...
  <li class="list-group-item"><label style="color:#c40000;"><?php echo ($val["g_price"]); ?></label></li>
</ul>
...
//               var key=$('#key').val();
	...
	//		 alert(data);
			 ...
			 location.href="<?php echo U('Goods/searchs');?>";
	//		    }
